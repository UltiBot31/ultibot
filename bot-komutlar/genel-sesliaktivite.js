...
if(!args[0]) return message.channel.send('Yanlış kullanım. Doğru kullanım: .sesli-aktivite yt/bio/pn/fio')
if(args[0] == 'yt') {
...
fetch(`https://discord.com/api/v8/channels/${message.member.voice.channel.id}/invites`, {
                ...
                .then(invite => {
                    ...
                    embed.setColor("BLUE")
                    embed.setFooter( "Krom Code Sunar...", client.user.avatarURL());
