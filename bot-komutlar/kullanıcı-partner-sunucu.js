...
const bg = await canvas.loadImage("./partner.png")
...
let resim = new MessageAttachment(resiim.create.toBuffer(), "PARTNER-SUNUCU-UMEFEK.png")
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ['partner-server'],
    permLevel: 0
};

exports.help = {
    name: 'partner-sunucu',
    description: 'Sunucuya partner efekti uygular.',
    usage: "partner-sunucu"
 }