...
if (!args[0]) return message.channel.send(new discord.MessageEmbed()                                          
    ...
    .setDescription("**.botlist-ayar botekle-kanal #kanal**\n**.botlist-ayar basvuru-kanal #kanal**\n**.botlist-ayar log-kanal #kanal**\n**.botlist-ayar yetkili-rol @rol**")
    .setColor("BLUE")
...
if (args[0] == "botekle-kanal") {
    ...
    message.channel.send(new discord.MessageEmbed()
        .setTitle("Başarılı!")
        .setFooter( "Subzero ", client.user.avatarURL())        .setColor("BLUE")
